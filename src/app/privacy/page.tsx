...
export const metadata = {
  ...
  description: "InternMatch AI Privacy Policy and student data protection details.",
};
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 pb-24">
        ...
        <div className="p-8 rounded-3xl bg-white border border-[#E5E7E8] shadow-xs space-y-6 text-sm text-[#656B70] leading-relaxed">
          ...
          <h2 className="text-lg font-bold text-[#171A1C]">
            Our Data Principles for University Students
          </h2>
          <p>
            InternMatch AI is built on candidate privacy and data minimization.
            Candidate CVs uploaded during application discovery are processed
            solely to extract structured skill signals, generate compatibility
            breakdowns, and assist in application draft preparation.
          </p>
          <ul className="list-disc list-inside space-y-2 text-[#171A1C]">
            <li>Original CV files are not altered.</li>
            <li>We do not sell student data to third-party ad networks.</li>
            <li>Data retention and deletion rights will be fully accessible before public release.</li>
          </ul>
          <p className="text-xs text-[#656B70] pt-4 border-t border-[#E5E7E8]">
            Official privacy inquiries and contact channels will be published prior to public launch.
          </p>
        </div>
      </main>
      <Footer />
